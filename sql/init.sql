...
-- -----------------------------------------------------
-- Table `tobee`.`colleges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tobee`.`colleges` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tobee`.`college_districts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tobee`.`college_districts` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tobee`.`users` (
  ...
  INDEX `fk_users_college_district_id_idx` (`college_district` ASC) ,
  CONSTRAINT `fk_users_city_id`
    FOREIGN KEY (`city_id`)
    REFERENCES `tobee`.`cities` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_college_district_id`
...
CREATE TABLE IF NOT EXISTS `tobee`.`organizations` (
  ...
  CONSTRAINT `fk_organization_college_district_id`
    FOREIGN KEY (`college_district`)
    REFERENCES `tobee`.`college_districts` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `tobee`.`organization_departments_address_list`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tobee`.`organization_departments_address_list` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `tobee`.`organizations_host_activities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tobee`.`organizations_host_activities` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `organization_id` INT NOT NULL,
  `activity_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_organizations_host_activities_organization_id`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_organizations_host_activities_activity_id`
    FOREIGN KEY (`activity_id`)
    REFERENCES `tobee`.`activities` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
